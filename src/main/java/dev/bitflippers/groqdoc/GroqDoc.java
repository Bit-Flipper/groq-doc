...
public class GroqDoc extends Recipe {
    ...
    private static final Message SYSTEM_MESSAGE = new Message(
            ...
            "You have been hired as a Javadoc writer. The user will send you a java interface and you will " +
                    "write the Javadoc for the methods. Do not respond with anything other than a pure Javadoc " +
                    "string. Let me repeat, do not send anything other than a pure Javadoc string, including any and all" +
                    "markdown formatting."
    );
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new JavaIsoVisitor<>() {
            ...
            private String generateJavadoc(String interfaceString) {
                Message interfaceMessage = new Message(Role.USER, interfaceString);
                Optional<List<GroqResponse.Choice>> maybeChoice = GROQ.createCompletion(SYSTEM_MESSAGE, interfaceMessage);
